...
type PluginUiSlotDeclaration = NonNullable<NonNullable<HOOKPluginManifestV1["ui"]>["slots"]>[number];
/** Launcher declaration extracted from plugin manifest */
type PluginLauncherDeclaration = NonNullable<HOOKPluginManifestV1["launchers"]>[number];
...
const BUNDLED_PLUGIN_EXAMPLES: AvailablePluginExample[] = [
  {
    ...
    description: "Reference UI plugin that adds a simple Hello World widget to the HOOK dashboard.",
  ...
  },
  {
    ...
    description: "Reference plugin that demonstrates the current HOOK plugin API surface, bridge flows, UI extension surfaces, jobs, webhooks, tools, streams, and trusted local workspace/process demos.",
