...
const manifest: HOOKPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current HOOK plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "HOOK",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the HOOK domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
