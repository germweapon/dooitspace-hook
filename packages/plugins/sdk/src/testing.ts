...
function requireCapability(manifest: HOOKPluginManifestV1, allowed: Set<PluginCapability>, capability: PluginCapability) {
 ...
 * can validate plugin behavior without spinning up the HOOK server runtime.
 */
