/**
 * `definePlugin` — the top-level helper for authoring a HOOK plugin.
 *
...
// ---------------------------------------------------------------------------
// HOOKPlugin — the sealed object returned by definePlugin()
// ---------------------------------------------------------------------------
 ...
 * @returns A sealed `HOOKPlugin` object for the host to consume
 *
 * @example
 * ```ts
 * import { definePlugin } from "@paperclipai/plugin-sdk";
