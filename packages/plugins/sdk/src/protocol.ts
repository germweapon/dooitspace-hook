 ...
 * channel.
 *
 * The HOOK plugin runtime uses JSON-RPC 2.0 over stdio to communicate
 ...
 * we use strings (UUIDs or monotonic counters) for all HOOK messages.
 */
...
/**
 * HOOK plugin-specific error codes.
 *
...
export interface InitializeParams {
  ...
  instanceInfo: {
    /** UUID of this HOOK instance. */
    instanceId: string;
    /** Semver version of the running HOOK host. */
    hostVersion: string;
  };
  /** Host API version. */
  apiVersion: number;
