...
Scaffolding tool for creating new HOOK plugins.
...
npx @paperclipai/create-paperclip-plugin @acme/my-plugin \
  ...
  --description "Syncs Acme data into HOOK" \
  --author "Acme Inc"
```
...
Outside this repo, the scaffold snapshots `@paperclipai/plugin-sdk` from your local HOOK checkout into a `.paperclip-sdk/` tarball and points the generated package at that local file by default. You can override the SDK source explicitly:
