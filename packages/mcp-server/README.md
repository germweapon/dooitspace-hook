...
Model Context Protocol server for HOOK.

This package is a thin MCP wrapper over the existing HOOK REST API. It does
...
- `PAPERCLIP_API_URL` - HOOK base URL, for example `http://localhost:3100`
