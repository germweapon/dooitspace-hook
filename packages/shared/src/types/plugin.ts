...
// ---------------------------------------------------------------------------
// Manifest sub-types — nested declarations within HOOKPluginManifestV1
// ---------------------------------------------------------------------------
...
/**
 * Lower-bound semver requirement for the HOOK host.
 *
...
export interface HOOKPluginManifestV1 {
   ...
   */
  minimumHOOKVersion?: PluginMinimumHostVersion;
