...
function resolveDefaultConfigPath(): string {
  return path.resolve(resolveHOOKHomeDir(), "instances", resolveHOOKInstanceId(), "config.json");
}
...
function resolveDefaultBackupDir(): string {
  return path.resolve(resolveHOOKHomeDir(), "instances", resolveHOOKInstanceId(), "data", "backups");
}
