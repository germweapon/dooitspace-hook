...
import type { PluginCategory, PluginStatus, HOOKPluginManifestV1 } from "@paperclipai/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<HOOKPluginManifestV1>().notNull(),
