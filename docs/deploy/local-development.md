...
summary: Set up HOOK for local development
---

Run HOOK locally with zero external dependencies.
...
No Docker or external database required. HOOK uses embedded PostgreSQL automatically.
...
To open HOOK to a private network with login enabled:
