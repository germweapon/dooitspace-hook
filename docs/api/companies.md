...
Manage companies within your HOOK instance.
...
Company logo uploads use the normal HOOK attachment size limit.
...
| `logoUrl` | string | Optional HOOK asset content path for the stored logo image |
