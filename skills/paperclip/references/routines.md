...
- Fire externally: `POST /api/routine-triggers/public/{publicId}/fire`
  ...
  - HMAC: `X-HOOK-Signature` + `X-HOOK-Timestamp` headers
...
Use the generic API endpoint tables in `skills/hook/references/api-reference.md` when you need a full cross-domain reference. Use this file when you need routine-specific behaviour, payload shape, or policy details.
