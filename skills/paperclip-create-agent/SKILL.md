---
name: hook-create-agent
description: >
  Create new agents in HOOK with governance-aware hiring. Use when you need
  to inspect adapter configuration options, compare existing agent configs,
  draft a new agent prompt/config, and submit a hire request.
---

# HOOK Create Agent Skill
...
2. Discover available adapter configuration docs for this HOOK instance.
...
- if the role needs skills, make sure they already exist in the company library or install them first using the HOOK company-skills workflow
...
`skills/hook-create-agent/references/api-reference.md`
