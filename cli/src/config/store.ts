...
import { paperclipConfigSchema, type HOOKConfig } from "./schema.js";
import {
...
export function resolveConfigPath(overridePath?: string): string {
  ...
  return findConfigFileFromAncestors(process.cwd()) ?? resolveDefaultConfigPath(resolveHOOKInstanceId());
}
...
export function readConfig(configPath?: string): HOOKConfig | null {
