...
- installed adapter list for this HOOK instance
...
## 8. New Skill: `hook-create-agent`

Create new skill directory:

- `skills/hook-create-agent/SKILL.md`
...
Also update `skills/hook/SKILL.md` to reference this skill for hiring workflows.
...
- `hook-create-agent` skill + docs updates
