...
This document translates [workspace-product-model-and-work-product.md](/Users/dotta/hook-subissues/doc/plans/workspace-product-model-and-work-product.md) into an implementation-ready engineering plan.
...
- `local`
  - HOOK may create host-local worktrees, processes, and paths
- `cloud`
  - HOOK should assume no durable host-local execution workspace management
