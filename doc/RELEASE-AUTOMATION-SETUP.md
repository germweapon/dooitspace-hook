...
This document covers the GitHub and npm setup required for the current HOOK release model:
...
Do this for every public package that HOOK publishes.
...
3. add a trusted publisher for the GitHub repository `hookai/hook`
...
2. revoke any personal automation token that used to publish HOOK
