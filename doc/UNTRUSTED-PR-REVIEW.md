...
This is intentionally separate from the normal HOOK dev image.
...
```sh
review-checkout-pr hookai/hook 432
cd /work/checkouts/hookai-hook/pr-432
```
...
## Preview the HOOK app from the PR
...
- HOOK's embedded PostgreSQL and local storage stay inside the container home volume via `PAPERCLIP_HOME=/home/reviewer/.hook-review`.
